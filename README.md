...
Overview
This repository contains the solution for the Alaka Research assignment. The task involves downloading financial data for BANKNIFTY options (dated January 10, 2024), processing the data to create 5-minute candlestick data, and calculating Fibonacci Pivot Points for the same date. The processed data is saved as CSV files, and the results are stored in this GitHub repository.
...
Install using:pip install s3cmd
...
Download the Input Data using s3cmd
...
Install the required Python libraries:pip install pandas pyarrow
...
Run the process_candles.py script to generate 5-minute candles and calculate Fibonacci Pivot Points:python process_candles.py
...
The date column represents 5-minute intervals for January 10, 2024.


Fibonacci Pivot Points:
The script prints the Fibonacci Pivot Points (P, R1, R2, R3, S1, S2, S3) for each file to the console.
Example output:Fibonacci Pivot Points for 46900PE.parquet.gz on 2024-01-10:
